//@/ui/graphics/schema/revenue.ts
import { z } from "zod";
import { TimeIntervalSchema } from "@/lib/data/schema/revenue";
import { FormOptionSchema, FormActionSchema, FormShapeSchema } from "@/ui/graphics/schema/form";
